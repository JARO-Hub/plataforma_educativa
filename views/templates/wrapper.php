...
<style>
        ...
        #RecursosCompartidosContenido {
            display: none;
        }
    </style>
<!--begin::Wrapper-->
    <div id="RecursosCompartidosContenido" class="app-wrapper flex-column flex-row-fluid" id="kt_app_wrapper">
                                        ...
                                        <div class="d-flex flex-stack flex-wrap gap-4 w-100">
                                            ...
                                            <div class="page-title d-flex flex-column gap-3 me-3">
                                                ...
                                                <h1
                                                    ...
                                                    Lista de carpetas compartidas</h1>
                                                <!--end::Title-->
                                                <!--begin::Breadcrumb-->
                                                                            ...
                                                                            <div class="fv-row mb-10">
                                                                                ...
                                                                                <!--begin::Input-->
                                                                                    <select name="role" data-control="select2"
                                                                                        ...
                                                                                        class="form-select form-select-solid fw-bold select2-hidden-accessible"
                                                                                        data-select2-id="select2-data-13-fpp1" tabindex="-1"
                                                                                    ...
                                                                                    class="select2 select2-container select2-container--bootstrap5"
                                                                                    dir="ltr" data-select2-id="select2-data-14-spqd"
                                                                                    style="width: 100%;"><span class="selection"><span
                                                                                            class="select2-selection select2-selection--single form-select form-select-solid fw-bold"
                                                                                            role="combobox" aria-haspopup="true"
                                                                                            aria-expanded="false" tabindex="0"
                                                                                            aria-disabled="false"
                                                                                            aria-labelledby="select2-role-qs-container"
                                                                                            aria-controls="select2-role-qs-container"><span
                                                                                                class="select2-selection__rendered"
                                                                                                id="select2-role-qs-container" role="textbox"
                                                            ...
                                                            <div class="modal-dialog modal-dialog-centered mw-650px">
                                                                ...
                                                                <div class="modal-content">
                                                                    ...
                                                                    <div class="modal-header" id="kt_modal_add_user_header">
                                                                        <!--begin::Modal title-->
                                                                        <h2 class="fw-bold">Nuevo recurso compartido</h2>
                                                                        <!--end::Modal title-->
                                                                        <!--begin::Close-->
                                                                        <div class="btn btn-icon btn-sm btn-active-icon-primary"
                                                                            data-kt-users-modal-action="close">
                                                                    ...
                                                                    <div class="modal-body scroll-y mx-5 mx-xl-15 my-7">
                                                                        ...
                                                                        <form id="kt_modal_add_user_form"
                                                                            ...
                                                                            <div class="d-flex flex-column scroll-y me-n7 pe-7"
                                                                                ...
                                                                                <div class="fv-row mb-7 fv-plugins-icon-container">
                                                                                    <!--begin::Label-->
                                                                                    <label class="fw-semibold fs-6 mb-2">Descripción del
                                                                                        recurso</label>
                                                                                    <!--end::Label-->
                                                                                    <!--begin::Input-->
                                                                                    <input type="email" name="comentario"
                                                                                        class="form-control form-control-solid mb-3 mb-lg-0"
                                                                                ...
                                                                                <div class="mb-7">
                                                                                    <!--begin::Label-->
                                                                                        <label class="required fw-semibold fs-6 mb-5">Tipo del
                                                                                        recurso compartido</label>
                                                                                    <!--end::Label-->
                                                                                    <!--begin::Roles-->
                                                                                        <!--begin::Input row-->
                                                                                        <div class="d-flex fv-row">
                                                                                            ...
                                                                                            <div
                                                                                                ...
                                                                                                <label class="form-check-label"
                                                                                                    ...
                                                                                                    <div class="fw-bold text-gray-800">Impresora
                                                                                                    </div>
                                                                                                    <div class="text-gray-600">Selecciona para
                                                                                                        indicar que el recurso compartido es una
                                                                                                        impresora</div>
                                                                                                </label>
                                                                                                <!--end::Label-->
                                                                                            </div>
                                                                                        ...
                                                                                        <div class="d-flex fv-row">
                                                                                            ...
                                                                                            <div
                                                                                                ...
                                                                                                <label class="form-check-label"
                                                                                                    ...
                                                                                                    <div class="fw-bold text-gray-800">Directorio
                                                                                                    </div>
                                                                                                    <div class="text-gray-600">Selecciona para
                                                                                                        indicar que el recurso compartido es un
                                                                                                        directorio</div>
                                                                                                </label>
                                                                                                <!--end::Label-->
                                                                                            </div>
                                                                                    ...
                                                                                    <!--end::Roles-->
                                                                                        ...
                                                                                        <div class="fv-row mb-7 fv-plugins-icon-container">
                                                                                            <!--begin::Label-->
                                                                                                <label class="required fw-semibold fs-6 mb-2">Ruta del
                                                                                                    recurso compartido</label>
                                                                                            <!--end::Label-->
                                                                                            <!--begin::Input-->
                                                                                                <input type="email" name="Ruta"
                                                                                                    class="form-control form-control-solid mb-3 mb-lg-0"
                                                                                                    placeholder="/home">
                                                                                                <input type="file">
                                                                                            <!--end::Input-->
                                                                                    ...
                                                                                    <label><input type="checkbox" id="Solo_lectura" />Solo
                                                                                    lectura</label>
                                                                                </div>
                                                                                <!--end::Input group-->
                                                                            </div>
                                                                ...
                                                                <thead>
                                                                    <tr class="text-start text-muted fw-bold fs-7 text-uppercase gs-0">
                                                                        ...
                                                                        <th class="text-end min-w-100px sorting_disabled" rowspan="1"
                                                                            colspan="1" aria-label="Actions" style="width: 132.609375px;">
                                                                            Comentario
                                                                        </th>
                                                                    </tr>
                                                                </thead>
